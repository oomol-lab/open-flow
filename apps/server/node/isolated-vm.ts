...
type ExecutorMessage =
  ...
  | { readonly executionId: number; readonly ok: true; readonly retire?: true; readonly type: 'result'; readonly value: FlowRunOutcome | JsonValue }
...
interface PendingInvocation {
  ...
  readonly resolve: (value: FlowRunOutcome | JsonValue) => void
...
function executeWithCapabilities(request: InvokeRequest, pending: Map<number, PendingCapability>, retire: () => boolean): Effect.Effect<void> {
  ...
  return Effect.scoped(
    Effect.gen(function* () {
      let value: FlowRunOutcome | JsonValue
