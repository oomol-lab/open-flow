...
const samples = {
  ...
  checkFlow: { engineContract: 'open-flow-engine/v3', version: 1 },
  publishFlow: { engineContract: 'open-flow-engine/v3', expectedLivePublicationId: null, version: 1 },
  rollbackFlow: { expectedLivePublicationId: 'p1', version: 1 },
  createDraftRun: { engineContract: 'open-flow-engine/v3', inputs: {}, trigger: { nodeId: 'start', payload: null }, version: 1 },
