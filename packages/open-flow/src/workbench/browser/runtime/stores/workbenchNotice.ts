...
const errorKeys = {
  ...
  [controlErrorCode.connectorAccessConflict]: 'notice.error.flowConflict',
  [controlErrorCode.connectorAccessInvalid]: 'notice.error.connectorAccessInvalid',
  [controlErrorCode.connectorAccessRequired]: 'notice.error.connectorAccessRequired',
  [controlErrorCode.connectorAccessUnsupported]: 'notice.error.connectorUnavailable',
