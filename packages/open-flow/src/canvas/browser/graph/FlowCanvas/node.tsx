...
import type { FlowCanvasViewCommentNode, FlowCanvasViewNode, FlowCanvasViewPosition, FlowCanvasViewSemanticNode, ViewCallbacks } from './model.ts'
...
interface SemanticNodeEntry {
  ...
  readonly kind: Exclude<FlowCanvasViewNode['kind'], 'comment'>
...
export function createCommentNodeEntry(
  node: FlowCanvasViewCommentNode,
  contentKey: string,
...
export function createNodeEntry(node: FlowCanvasViewSemanticNode, contentKey: string, canvasStore: CanvasStore): SemanticNodeEntry {
  ...
  const store = new NodeStore(node.id as NodeId, types[node.kind], {
    ignoredNodeIds: canvasStore.ignoredNodeIds,
...
export function updateNodeEntry(entry: SemanticNodeEntry, node: FlowCanvasViewSemanticNode, contentKey: string): SemanticNodeEntry {
