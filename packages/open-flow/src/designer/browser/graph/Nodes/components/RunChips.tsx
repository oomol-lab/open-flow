...
import type { FlowDesignerViewNodeRun } from '../../FlowDesigner/model.ts'
...
export function ImagePreview({ images, run, title }: { readonly images: readonly string[]; readonly run: FlowDesignerViewNodeRun; readonly title: string }) {
  const t = useTranslate()
