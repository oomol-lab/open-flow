...
export type NodePickerItem = FlowDesignerViewAddItem | { readonly type: 'divider'; readonly label: string }

/** Present the product catalog without converting node or port definitions. */
export function nodePickerItems(items: readonly FlowDesignerViewAddItem[], connectionSide?: 'left' | 'right'): NodePickerItem[] {
