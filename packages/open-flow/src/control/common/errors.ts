...
export const controlErrorMetadata = {
  [controlErrorCode.eventSourceInvalid]: { status: 400 },
  [controlErrorCode.eventSourceIdentityUnavailable]: { status: 409 },
  [controlErrorCode.eventSourceNotFound]: { status: 404 },
  [controlErrorCode.eventSourceConflict]: { status: 409 },
  ...
  [controlErrorCode.connectorConsoleUnconfigured]: { status: 503 },
