...
const schemas = {
  ...
  removeConnectionUsage: z.strictObject({ connectionId: id, expectedRevisionId: id, expectedAccessRevision: z.int().nonnegative(), version }),
...
export const controlRequests = {
  ...
  removeConnectionUsage: decoder(schemas.removeConnectionUsage),
