...
`open-flow-engine/v4/nodejs-compat-v1` extends the v2 execution model with a fixed builtin module
allowlist. The existing `open-flow-engine/v4` contract is unchanged. Deployments advertise this
