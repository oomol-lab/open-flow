...
Задавайте структуру типизированными узлами, сохраняйте пользовательскую логику в виде настоящего
JavaScript или TypeScript и запускайте автоматизацию в OOMOL Hosted или на собственной инфраструктуре.
...
- **Делайте зависимости данных явными.** Каждый Task и Subflow объявляет именованные типизированные входы и выходы. Каждое ребро связывает конкретное выходное значение с конкретным входом, поэтому граф является моделью зависимостей данных, которую использует runtime.
...
Каждый Task и Subflow объявляет именованные типизированные входы и выходы. Ребро переносит значение с конкретного выхода на конкретный вход, а runtime запускает узел, когда его входы готовы.
